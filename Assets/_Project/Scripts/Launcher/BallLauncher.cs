...
namespace _Project.Scripts.Launcher
{
    public class BallLauncher : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(Ball.Factory ballFactory, PlanetModel planetModel, GameplayInput gameplayInput)
        {
        ...
        private void SpawnNextBall()
        {
            ...
            if (_lineRenderer != null)
            {
                ...
                {
                    var ballColor = ballRenderer.material.color;
                    _lineRenderer.startColor = ballColor;
                    _lineRenderer.endColor = ballColor;
                }
            }
